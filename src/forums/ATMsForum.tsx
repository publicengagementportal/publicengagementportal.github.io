...
const ATMsForum = () => {
  const [posts, setPosts] = useState<{ id: string; parish?: string; city?: string; atmLocation?: string; severity?: string; comments?: string; timestamp?: string; createdAt?: Date }[]>([]);
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        const postsRef = collection(db, 'atmsForumPosts');
  ...
  const handlePostSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const newPost = {
        ...
        atmLocation: formElements.atmLocation.value,
      ...
      const docRef = await addDoc(collection(db, 'atmsForumPosts'), newPost);
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="w-2/3 p-6">
        <h1 className="text-3xl font-bold mb-4">ATMs Forum</h1>
        <p className="mb-4">Welcome to the ATMs discussion forum. Share your thoughts and ideas about ATMs here.</p>
        <button
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <form onSubmit={handlePostSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-gray-700">ATM Location:</label>
              <input 
                type="text" 
                name="atmLocation" 
                required
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="Card Reader Issue">Card Reader Issue</option>
                <option value="Cash Dispenser Issue">Cash Dispenser Issue</option>
          ...
          <div className="space-y-4">
            {posts.map((post) => (
              <div key={post.id} className="border border-gray-200 rounded-lg p-4">
                ...
                <p>City: {post.city}</p>
                <p>ATM Location: {post.atmLocation}</p>
